...
*/   
	    ...
	    // Méthodes
	    public Environnement_2(int _nbAtomes, double _largeur, double _hauteur) {
	        largeur = _largeur;
	        hauteur = _hauteur;
	        ...
	        for (int i = 0; i < _nbAtomes; i++) {
	        	...
	        	atomes[i] = new Atome(number, generateur.nextDouble() * largeur, generateur.nextDouble() * hauteur, generateur.nextDouble() * 2 * Math.PI);
	        }
	    }
